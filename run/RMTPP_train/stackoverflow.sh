#!/bin/bash
# Runs RMTPP_train on stackoverflow dataset.
...
CONFIG_FILE="run/RMTPP_train/stackoverflow_config.yaml"
MODEL_ID="RMTPP_train"
...
echo "Config: run/RMTPP_train/stackoverflow_config.yaml"
...
" "run/RMTPP_train/stackoverflow_config.yaml" "RMTPP_train" "stackoverflow" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
