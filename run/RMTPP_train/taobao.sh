#!/bin/bash
# Runs RMTPP_train on taobao dataset.
...
CONFIG_FILE="run/RMTPP_train/taobao_config.yaml"
...
echo "Config: run/RMTPP_train/taobao_config.yaml"
...
" "run/RMTPP_train/taobao_config.yaml" "RMTPP_train" "taobao" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
