#!/bin/bash
# Runs RMTPP_train on retweet dataset.
...
CONFIG_FILE="run/RMTPP_train/retweet_config.yaml"
...
echo "Config: run/RMTPP_train/retweet_config.yaml"
...
" "run/RMTPP_train/retweet_config.yaml" "RMTPP_train" "retweet" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
