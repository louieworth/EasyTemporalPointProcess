#!/bin/bash
# Runs RMTPP_train on e_commerce dataset.
...
CONFIG_FILE="run/RMTPP_train/e_commerce_config.yaml"
...
echo "Config: run/RMTPP_train/e_commerce_config.yaml"
...
" "run/RMTPP_train/e_commerce_config.yaml" "RMTPP_train" "e_commerce" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
