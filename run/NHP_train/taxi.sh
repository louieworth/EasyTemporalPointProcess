#!/bin/bash
# Runs NHP_train on taxi dataset.
...
CONFIG_FILE="run/NHP_train/taxi_config.yaml"
MODEL_ID="NHP_train"
DATASET_ID="taxi"
...
echo "Config: run/NHP_train/taxi_config.yaml"
...
" "run/NHP_train/taxi_config.yaml" "NHP_train" "taxi" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
