#!/bin/bash
# Runs NHP_train on amazon dataset.
...
CONFIG_FILE="run/NHP_train/amazon_config.yaml"
MODEL_ID="NHP_train"
DATASET_ID="amazon"
...
echo "Config: run/NHP_train/amazon_config.yaml"
...
" "run/NHP_train/amazon_config.yaml" "NHP_train" "amazon" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
