#!/bin/bash
# Runs NHP_train on stackoverflow dataset.
...
CONFIG_FILE="run/NHP_train/stackoverflow_config.yaml"
MODEL_ID="NHP_train"
...
echo "Config: run/NHP_train/stackoverflow_config.yaml"
...
" "run/NHP_train/stackoverflow_config.yaml" "NHP_train" "stackoverflow" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
