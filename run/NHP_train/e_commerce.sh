#!/bin/bash
# Runs NHP_train on e_commerce dataset.
...
CONFIG_FILE="run/NHP_train/e_commerce_config.yaml"
MODEL_ID="NHP_train"
...
echo "Config: run/NHP_train/e_commerce_config.yaml"
...
" "run/NHP_train/e_commerce_config.yaml" "NHP_train" "e_commerce" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
