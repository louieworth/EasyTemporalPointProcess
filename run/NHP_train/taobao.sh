#!/bin/bash
# Runs NHP_train on taobao dataset.
...
CONFIG_FILE="run/NHP_train/taobao_config.yaml"
MODEL_ID="NHP_train"
DATASET_ID="taobao"
...
echo "Config: run/NHP_train/taobao_config.yaml"
...
" "run/NHP_train/taobao_config.yaml" "NHP_train" "taobao" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
