#!/bin/bash
# Runs NHP_train on retweet dataset.
...
CONFIG_FILE="run/NHP_train/retweet_config.yaml"
MODEL_ID="NHP_train"
DATASET_ID="retweet"
...
echo "Config: run/NHP_train/retweet_config.yaml"
...
" "run/NHP_train/retweet_config.yaml" "NHP_train" "retweet" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
