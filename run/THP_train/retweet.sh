#!/bin/bash
# Runs THP_train on retweet dataset.
...
CONFIG_FILE="run/THP_train/retweet_config.yaml"
MODEL_ID="THP_train"
DATASET_ID="retweet"
...
echo "Config: run/THP_train/retweet_config.yaml"
...
" "run/THP_train/retweet_config.yaml" "THP_train" "retweet" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
