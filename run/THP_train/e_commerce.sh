#!/bin/bash
# Runs THP_train on e_commerce dataset.
...
CONFIG_FILE="run/THP_train/e_commerce_config.yaml"
MODEL_ID="THP_train"
...
echo "Config: run/THP_train/e_commerce_config.yaml"
...
" "run/THP_train/e_commerce_config.yaml" "THP_train" "e_commerce" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
