#!/bin/bash
# Runs THP_train on taobao dataset.
...
CONFIG_FILE="run/THP_train/taobao_config.yaml"
MODEL_ID="THP_train"
DATASET_ID="taobao"
...
echo "Config: run/THP_train/taobao_config.yaml"
...
" "run/THP_train/taobao_config.yaml" "THP_train" "taobao" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
