#!/bin/bash
# Runs THP_train on amazon dataset.
...
CONFIG_FILE="run/THP_train/amazon_config.yaml"
MODEL_ID="THP_train"
DATASET_ID="amazon"
...
echo "Config: run/THP_train/amazon_config.yaml"
...
" "run/THP_train/amazon_config.yaml" "THP_train" "amazon" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
