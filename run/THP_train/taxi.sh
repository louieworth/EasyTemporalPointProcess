#!/bin/bash
# Runs THP_train on taxi dataset.
...
CONFIG_FILE="run/THP_train/taxi_config.yaml"
MODEL_ID="THP_train"
DATASET_ID="taxi"
...
echo "Config: run/THP_train/taxi_config.yaml"
...
" "run/THP_train/taxi_config.yaml" "THP_train" "taxi" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
