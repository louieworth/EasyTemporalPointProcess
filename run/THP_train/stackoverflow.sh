#!/bin/bash
# Runs THP_train on stackoverflow dataset.
...
CONFIG_FILE="run/THP_train/stackoverflow_config.yaml"
MODEL_ID="THP_train"
...
echo "Config: run/THP_train/stackoverflow_config.yaml"
...
" "run/THP_train/stackoverflow_config.yaml" "THP_train" "stackoverflow" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
