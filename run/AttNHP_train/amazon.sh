#!/bin/bash
# Runs AttNHP_train on amazon dataset.
...
CONFIG_FILE="run/AttNHP_train/amazon_config.yaml"
...
echo "Config: run/AttNHP_train/amazon_config.yaml"
...
" "run/AttNHP_train/amazon_config.yaml" "AttNHP_train" "amazon" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
