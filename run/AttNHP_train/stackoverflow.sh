#!/bin/bash
# Runs AttNHP_train on stackoverflow dataset.
...
CONFIG_FILE="run/AttNHP_train/stackoverflow_config.yaml"
MODEL_ID="AttNHP_train"
...
echo "Config: run/AttNHP_train/stackoverflow_config.yaml"
...
" "run/AttNHP_train/stackoverflow_config.yaml" "AttNHP_train" "stackoverflow" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
