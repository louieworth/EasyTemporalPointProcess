#!/bin/bash
# Runs AttNHP_train on e_commerce dataset.
...
CONFIG_FILE="run/AttNHP_train/e_commerce_config.yaml"
...
echo "Config: run/AttNHP_train/e_commerce_config.yaml"
...
# Pass shell variables directly to Python
python3 << EOF
import sys
import traceback
import os

# Add project root to Python path (we're already at project root)
