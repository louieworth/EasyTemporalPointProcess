#!/bin/bash
# Runs AttNHP_train on taobao dataset.
...
CONFIG_FILE="run/AttNHP_train/taobao_config.yaml"
...
echo "Config: run/AttNHP_train/taobao_config.yaml"
...
" "run/AttNHP_train/taobao_config.yaml" "AttNHP_train" "taobao" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
