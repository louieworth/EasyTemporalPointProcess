#!/bin/bash
# Runs AttNHP_train on retweet dataset.
...
CONFIG_FILE="run/AttNHP_train/retweet_config.yaml"
...
echo "Config: run/AttNHP_train/retweet_config.yaml"
...
" "run/AttNHP_train/retweet_config.yaml" "AttNHP_train" "retweet" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
