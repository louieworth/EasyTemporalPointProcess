#!/bin/bash
# Runs ODETPP_train on retweet dataset.
...
CONFIG_FILE="run/ODETPP_train/retweet_config.yaml"
...
echo "Config: run/ODETPP_train/retweet_config.yaml"
...
" "run/ODETPP_train/retweet_config.yaml" "ODETPP_train" "retweet" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
