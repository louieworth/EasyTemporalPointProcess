#!/bin/bash
# Runs ODETPP_train on stackoverflow dataset.
...
CONFIG_FILE="run/ODETPP_train/stackoverflow_config.yaml"
...
echo "Config: run/ODETPP_train/stackoverflow_config.yaml"
...
" "run/ODETPP_train/stackoverflow_config.yaml" "ODETPP_train" "stackoverflow" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
