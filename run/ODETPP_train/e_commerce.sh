#!/bin/bash
# Runs ODETPP_train on e_commerce dataset.
...
CONFIG_FILE="run/ODETPP_train/e_commerce_config.yaml"
...
echo "Config: run/ODETPP_train/e_commerce_config.yaml"
...
" "run/ODETPP_train/e_commerce_config.yaml" "ODETPP_train" "e_commerce" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
