#!/bin/bash
# Runs ODETPP_train on amazon dataset.
...
CONFIG_FILE="run/ODETPP_train/amazon_config.yaml"
...
echo "Config: run/ODETPP_train/amazon_config.yaml"
...
" "run/ODETPP_train/amazon_config.yaml" "ODETPP_train" "amazon" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
