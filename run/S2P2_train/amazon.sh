#!/bin/bash
# Runs S2P2_train on amazon dataset.
...
CONFIG_FILE="run/S2P2_train/amazon_config.yaml"
MODEL_ID="S2P2_train"
DATASET_ID="amazon"
...
echo "Config: run/S2P2_train/amazon_config.yaml"
...
" "run/S2P2_train/amazon_config.yaml" "S2P2_train" "amazon" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
