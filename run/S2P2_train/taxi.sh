#!/bin/bash
# Runs S2P2_train on taxi dataset.
...
CONFIG_FILE="run/S2P2_train/taxi_config.yaml"
MODEL_ID="S2P2_train"
DATASET_ID="taxi"
...
echo "Config: run/S2P2_train/taxi_config.yaml"
...
" "run/S2P2_train/taxi_config.yaml" "S2P2_train" "taxi" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
