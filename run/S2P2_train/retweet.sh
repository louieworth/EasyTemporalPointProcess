#!/bin/bash
# Runs S2P2_train on retweet dataset.
...
CONFIG_FILE="run/S2P2_train/retweet_config.yaml"
MODEL_ID="S2P2_train"
DATASET_ID="retweet"
...
echo "Config: run/S2P2_train/retweet_config.yaml"
...
" "run/S2P2_train/retweet_config.yaml" "S2P2_train" "retweet" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
