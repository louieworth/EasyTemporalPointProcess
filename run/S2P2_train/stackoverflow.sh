#!/bin/bash
# Runs S2P2_train on stackoverflow dataset.
...
CONFIG_FILE="run/S2P2_train/stackoverflow_config.yaml"
MODEL_ID="S2P2_train"
...
echo "Config: run/S2P2_train/stackoverflow_config.yaml"
...
" "run/S2P2_train/stackoverflow_config.yaml" "S2P2_train" "stackoverflow" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
