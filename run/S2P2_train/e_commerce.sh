#!/bin/bash
# Runs S2P2_train on e_commerce dataset.
...
CONFIG_FILE="run/S2P2_train/e_commerce_config.yaml"
MODEL_ID="S2P2_train"
...
echo "Config: run/S2P2_train/e_commerce_config.yaml"
...
" "run/S2P2_train/e_commerce_config.yaml" "S2P2_train" "e_commerce" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
