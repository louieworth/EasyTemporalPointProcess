#!/bin/bash
# Runs S2P2_train on taobao dataset.
...
CONFIG_FILE="run/S2P2_train/taobao_config.yaml"
MODEL_ID="S2P2_train"
DATASET_ID="taobao"
...
echo "Config: run/S2P2_train/taobao_config.yaml"
...
" "run/S2P2_train/taobao_config.yaml" "S2P2_train" "taobao" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
