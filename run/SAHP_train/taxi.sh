#!/bin/bash
# Runs SAHP_train on taxi dataset.
...
CONFIG_FILE="run/SAHP_train/taxi_config.yaml"
MODEL_ID="SAHP_train"
DATASET_ID="taxi"
...
echo "Config: run/SAHP_train/taxi_config.yaml"
...
" "run/SAHP_train/taxi_config.yaml" "SAHP_train" "taxi" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
