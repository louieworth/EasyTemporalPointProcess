#!/bin/bash
# Runs SAHP_train on retweet dataset.
...
CONFIG_FILE="run/SAHP_train/retweet_config.yaml"
MODEL_ID="SAHP_train"
DATASET_ID="retweet"
...
echo "Config: run/SAHP_train/retweet_config.yaml"
...
" "run/SAHP_train/retweet_config.yaml" "SAHP_train" "retweet" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
