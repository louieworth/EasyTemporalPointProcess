#!/bin/bash
# Runs SAHP_train on e_commerce dataset.
...
CONFIG_FILE="run/SAHP_train/e_commerce_config.yaml"
MODEL_ID="SAHP_train"
...
echo "Config: run/SAHP_train/e_commerce_config.yaml"
...
" "run/SAHP_train/e_commerce_config.yaml" "SAHP_train" "e_commerce" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
