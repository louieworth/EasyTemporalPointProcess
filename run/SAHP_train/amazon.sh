#!/bin/bash
# Runs SAHP_train on amazon dataset.
...
CONFIG_FILE="run/SAHP_train/amazon_config.yaml"
MODEL_ID="SAHP_train"
DATASET_ID="amazon"
...
echo "Config: run/SAHP_train/amazon_config.yaml"
...
" "run/SAHP_train/amazon_config.yaml" "SAHP_train" "amazon" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
