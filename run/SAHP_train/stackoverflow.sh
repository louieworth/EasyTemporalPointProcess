#!/bin/bash
# Runs SAHP_train on stackoverflow dataset.
...
CONFIG_FILE="run/SAHP_train/stackoverflow_config.yaml"
MODEL_ID="SAHP_train"
...
echo "Config: run/SAHP_train/stackoverflow_config.yaml"
...
" "run/SAHP_train/stackoverflow_config.yaml" "SAHP_train" "stackoverflow" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
