#!/bin/bash
# Runs SAHP_train on taobao dataset.
...
CONFIG_FILE="run/SAHP_train/taobao_config.yaml"
MODEL_ID="SAHP_train"
DATASET_ID="taobao"
...
echo "Config: run/SAHP_train/taobao_config.yaml"
...
" "run/SAHP_train/taobao_config.yaml" "SAHP_train" "taobao" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
