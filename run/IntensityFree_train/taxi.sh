#!/bin/bash
# Runs IntensityFree_train on taxi dataset.
...
CONFIG_FILE="run/IntensityFree_train/taxi_config.yaml"
...
echo "Config: run/IntensityFree_train/taxi_config.yaml"
...
" "run/IntensityFree_train/taxi_config.yaml" "IntensityFree_train" "taxi" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
