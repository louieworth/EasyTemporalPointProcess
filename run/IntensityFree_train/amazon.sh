#!/bin/bash
# Runs IntensityFree_train on amazon dataset.
...
CONFIG_FILE="run/IntensityFree_train/amazon_config.yaml"
...
echo "Config: run/IntensityFree_train/amazon_config.yaml"
...
" "run/IntensityFree_train/amazon_config.yaml" "IntensityFree_train" "amazon" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
