#!/bin/bash
# Runs IntensityFree_train on taobao dataset.
...
CONFIG_FILE="run/IntensityFree_train/taobao_config.yaml"
...
echo "Config: run/IntensityFree_train/taobao_config.yaml"
...
" "run/IntensityFree_train/taobao_config.yaml" "IntensityFree_train" "taobao" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
