#!/bin/bash
# Runs IntensityFree_train on e_commerce dataset.
...
CONFIG_FILE="run/IntensityFree_train/e_commerce_config.yaml"
...
echo "Config: run/IntensityFree_train/e_commerce_config.yaml"
...
" "run/IntensityFree_train/e_commerce_config.yaml" "IntensityFree_train" "e_commerce" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
