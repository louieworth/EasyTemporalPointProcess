#!/bin/bash
# Runs IntensityFree_train on stackoverflow dataset.
...
CONFIG_FILE="run/IntensityFree_train/stackoverflow_config.yaml"
MODEL_ID="IntensityFree_train"
...
echo "Config: run/IntensityFree_train/stackoverflow_config.yaml"
...
" "run/IntensityFree_train/stackoverflow_config.yaml" "IntensityFree_train" "stackoverflow" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
