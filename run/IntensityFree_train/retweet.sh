#!/bin/bash
# Runs IntensityFree_train on retweet dataset.
...
CONFIG_FILE="run/IntensityFree_train/retweet_config.yaml"
...
echo "Config: run/IntensityFree_train/retweet_config.yaml"
...
" "run/IntensityFree_train/retweet_config.yaml" "IntensityFree_train" "retweet" "$MAIN_CSV" "$TIMESTAMP" > "$LOG_FILE" 2>&1
